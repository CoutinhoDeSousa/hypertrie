...
class Hypertrie(ConanFile):
    ...
    requires = "boost/1.72.0", "tsl-hopscotch-map/2.2.1@tessil/stable", "fmt/6.1.2", "abseil/20200205", "Catch2/2.11.1@catchorg/stable", "tsl-sparse-map/0.6.2@tessil/stable"
